  ...
  return (
    <div className='hidden lg:inline ml-8 xl:w-[450px] py-1 space-y-5'>
        ...
        <MagnifyingGlassIcon className='text-gray-500 h-5 z-50'/>
            <input type="text" className="bg-transparent placeholder-gray-500 outline-none text-[#d9d9d9] absolute inset-0 pl-11 border border-transparent w-full focus:border-[#1d9bf0] rounded-full focus:g-black focus:shadow-lg"
